class GiftsController < ApplicationController
  ...
  def index
    ...
    # check this
    # @etsy_url = "https://openapi.etsy.com/v2/listings/active?api_key="+"#{ENV['ETSY_KEYSTRING']}"+"&fields=title,price,tags,url,category_path&limit=5&includes=MainImage&search?q="+@user_input
   user_input = []
