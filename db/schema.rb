...
ActiveRecord::Schema.define(version: 20140401234005) do
  ...
  add_index "relationships", ["friend_id", "other_friend_id"], name: "index_relationships_on_friend_id_and_other_friend_id", unique: true, using: :btree
  add_index "relationships", ["friend_id"], name: "index_relationships_on_friend_id", using: :btree
  add_index "relationships", ["other_friend_id"], name: "index_relationships_on_other_friend_id", using: :btree
